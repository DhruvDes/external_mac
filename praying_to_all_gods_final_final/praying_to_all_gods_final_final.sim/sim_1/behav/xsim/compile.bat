...
REM
REM Generated by Vivado on Wed Jul 16 17:30:55 +0400 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_c_to_f_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_c_to_f_vlog.prj -log xvlog.log
